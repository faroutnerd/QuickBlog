...
const BlogList = () => {
  ...
  return (
    <div>
          ...
          <div key={item} className="relative">
            <button onClick={() => setMenu(item)} className={`cursor-pointer text-gray-500 ${menu === item &&'text-white px-4 pt-0.5'}`}>
                ...
                {menu === item && (
                    ...
                    transotion={{type: 'spring', stiffness: 500, damping: 30}}
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-8 mb-24 sm:mx-1 xl:mx-40">
        {filterBlogs()
